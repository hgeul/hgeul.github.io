...
- **축 6. 담백한 문체 (AI 티)**
  `.claude/rules/writing-style.md` 의 "AI 티 제거" 절 기준으로, 사람이 쓴 티가 안 나는 문장을 **파일:라인으로 지목**한다.
  격언·잠언조, 균형 대구, 리본형 마무리, "결론부터 말하면" 류 서두, 볼드 남발, 기업 보고서 말투가 대상.
  예: "`docetl.md:74` '도구의 값어치는 경계에서 드러난다'는 격언조라 AI 티가 난다. 구체 사실로 바꿀 수 있나?"
